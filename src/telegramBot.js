...
const HELP_TEXT = [
  ...
  "/harvestrecover - request guarded recovery of a verified D-064 harvest halt",
  "/confirmharvestrecover CODE - type the code; every book must be fresh and reconciled (flat halts also require virtual 0, broker 0, lots 0)",
...
export async function startTelegramBot({
  ...
  await bot.setMyCommands([
    ...
    { command: "harvestrecover", description: "Recover a verified D-064 harvest halt" },
